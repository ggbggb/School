...
(
    ...
    [PayerPK] UNIQUEIDENTIFIER NOT NULL, 
    [PayeePK] UNIQUEIDENTIFIER NOT NULL,
    CONSTRAINT FK_TRANSACTIONS_SCHOOL FOREIGN KEY ([SchoolPK]) REFERENCES [Schools](SchoolPK),
    CONSTRAINT FK_TRANSACTIONS_PAYER FOREIGN KEY ([PayerPK]) REFERENCES [Contacts](ContactPK),
    CONSTRAINT FK_TRANSACTIONS_PAYEE FOREIGN KEY ([PayeePK]) REFERENCES [Contacts](ContactPK),
)
